#!/usr/bin/env python3
"""批次四 reader：水位库容曲线推求.xls（08-历年洪水统计，F1 之最 523 块，12 sheet 曲线推求工作簿）。

与 extract_xls_wave4.py 同通道（语料字节 stdin 管进 docker calamine，
sheet_name=None header=None 全量网格），写出 survey/extract_水位库容曲线推求.xls.json。
只读语料根，零落盘语料。
"""
import json
import subprocess
...
TARGETS = {
    "水位库容曲线推求.xls": "06-历年洪水资料/08-历年洪水统计/水位库容曲线推求.xls",
}
