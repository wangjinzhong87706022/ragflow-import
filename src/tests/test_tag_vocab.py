...
def test_vocab_rows_count():
    assert len(VOCAB_ROWS) == 16  # 5 knowledge-type + 11 flood-event（2018-8 系 2008 目录名纠偏新增；2010-7/2010-8 系 F1 批次二按内容归场新增）
