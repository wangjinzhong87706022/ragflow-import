"""移植自 rag/graphrag/light/graph_extractor.py —— 逐字保留提取流程。

改动仅限 import 替换：
  - rag.graphrag.general.extractor -> graphrag_port.extractor
  - rag.graphrag.light.graph_prompt -> graphrag_port.graph_prompt
  - rag.graphrag.utils             -> graphrag_port.local_utils
  - common.token_utils             -> graphrag_port.local_utils
"""
import logging
import re
...
from graphrag_port.extractor import ENTITY_EXTRACTION_MAX_GLEANINGS, Extractor
from graphrag_port.graph_prompt import PROMPTS
